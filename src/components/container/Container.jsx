            ...
            <div id='content-1' >
                <div id='content-01'>
                    <div id="content-profile-template">
                        ...
                        <div id='content-name-mobile-bond'>
                            <div id='content-name'>{choseUser["name"]}</div>
                            <div id='content-mobile'>{choseUser["phone"]}</div>
                        </div>
                    </div>
                    ...
                    <form >
                        <div id='form-fields'>
                            ...
                            <div className='inline-field'>
                                <label id='form-address-label' htmlFor="form-address">Address:</label>
